    ...
    <div class="w-full flex items-center justify-center">
      <div class="flex flex-col gap-12 md:w-1/2 w-full">
        ...
        <p class="md:text-lg text-sm font-mrglovani">
          &nbsp;მე, <span class="text-primary-blue font-mrglovani">{{ visitLinkResponse?.fullName }} </span> (პირადი
          ნომერი <span class="text-primary-blue font-mrglovani">{{ visitLinkResponse?.idNum }}</span>),
          თანხმობას ვაცხადებ, რომ სს”ბანკი ქართუ”-მ ერთჯერადად გამოითხოვოს და მიიღოს საქართველოს ფინანსთა სამინისტროს
          შემოსავლების სამსახურის მონაცემთა ერთიან ელექტრონულ ბაზაში
          ჩემზე არსებული ნებისმიერი სახის ინფორმაცია, რომელიც დაკავშირებულია ჩემს შემოსავლებთან. ჩემთვის ცნობილია და
          თანხმობას ვაცხადებ, რომ მონაცემთა
          დამუშავების მიზანია: ჩემი გადახდისუნარიანობის შეფასება სესხის გაცემამდე. მე თანახმა ვარ ბანკმა მიღებული
          ინფორმაცია დაამუშავოს, შეინახოს და გამოიყენოს
