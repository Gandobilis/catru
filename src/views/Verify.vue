    ...
    <div class="w-full flex items-center justify-center">
      <div class="flex flex-col gap-12 md:w-1/2 w-full">
        ...
        <div class="flex gap-1.5 items-center">
          <input  type="checkbox" v-model="isChecked" class="md:w-[20px] md:h-[20px] w-14px h-14px appearance-none border  rounded custom-checkbox" />
          <p class="md:text-lg text-sm">ვეთანხმები</p>
        </div>

        <div class="w-full flex md:justify-end justify-center gap-4">
          <button class=" rounded-xl p-3 md:text-lg text-sm  text-white bg-secondary-button-default font-mtavruli hover:bg-secondary-button-hover hover:transition">
            უარყოფა
          </button>
